...
## Download this file
    ...
    git clone https://github.com/WISE-PaaS/example-py-iothub-postgresql-dashboard.git
...
We bind service in **manifest.yml** in `services`，and we will bind again in downside use command line，but we can't bind postgresql in manifest.yml because the postgresql need bind group first。
